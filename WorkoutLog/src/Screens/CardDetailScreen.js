...
const CardDetailScreen = ({ route }) => {
  ...
  const handleSave = () => {
    ...
    // You can save the workout data to your desired location or perform other actions here.
  };
            ...
            <Slider
              ...
              onValueChange={(value) => {
                setSets(value);
                                ...
                                const repsArray = new Array(Math.floor(value)).fill(0);
                                const weightsArray = new Array(Math.floor(value)).fill(0);
                                setReps(repsArray);
